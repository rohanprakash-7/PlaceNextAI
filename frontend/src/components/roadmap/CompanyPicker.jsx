  ...
  return (
    <div className="glass-card p-6">
      <div className="flex items-center gap-2">
        ...
        <h2 className="font-display text-lg font-semibold text-white">Target a company</h2>
      </div>
      ...
      <div className="mt-4 flex flex-wrap gap-2">
        <button
          ...
          className={
            ...
            (selected === "" ? "bg-brand-gradient text-white" : "glass text-slate-400 hover:text-white")
          }
        >
          All companies
        </button>
        {companies.map((company) => (
          <button
            ...
            className={
              "rounded-full px-3.5 py-1.5 text-xs font-medium transition-colors " +
              (selected === company ? "bg-brand-gradient text-white" : "glass text-slate-400 hover:text-white")
            }
          >
            {company}
          </button>

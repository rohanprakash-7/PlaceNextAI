  ...
  return (
    <div className="glass-card overflow-hidden">
      <div className="border-b border-white/5 px-6 py-5">
        <h2 className="font-display text-lg font-semibold text-white">Side-by-side comparison</h2>
      </div>
          ...
          <thead>
            <tr className="border-b border-white/5 text-xs uppercase tracking-wider text-slate-500">
              ...
              {candidates.map((candidate) => (
                <th key={candidate.studentId} className="px-6 py-3.5 font-medium text-slate-300">
          ...
          <tbody>
            {rows.map((row) => (
              <tr key={row.key} className="border-b border-white/5 last:border-0">
                ...
                {candidates.map((candidate) => (
                  <td key={candidate.studentId} className="px-6 py-3.5 font-semibold text-white">
                    {candidate[row.key]}
                  </td>
                ))}
              </tr>
